...
export const MOCK_PRODUCTS: Product[] = [
  // 1. Herramientas Eléctricas (cat-1)
  {
    ...
    images: [
      {
        id: "img-1-1",
        url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSC6lVJHoUG6jTJvWiRYx48dnCOIwaP2PtYVSd2nlQW2MufRGFpge-UMsoj&s=10",
        alt: "Taladro Percutor Bosch GSB 550 RE",
        isPrimary: true,
      },
      {
        id: "img-1-2",
        url: "https://boschherramientasargentina.vtexassets.com/arquivos/ids/179054-800-auto?v=638732568676330000&width=800&height=auto&aspect=true",
  ...
  },
  {
    ...
    categoryName: "Herramientas Eléctricas",
    description:
      "Esmeril angular de 4-1/2 pulgadas DeWalt con motor de 750W de alta eficiencia. Cuenta con sistema de extracción de polvo, engranajes helicoidales que reducen la vibración y prolongan la vida útil de la herramienta. Ideal para cortes precisos en metal, concreto y desbaste profesional.",
    shortDescription:
      "Potente motor de 750W, 12,000 RPM, mango lateral de 2 posiciones y guarda ajustable.",
    features: [
    ...
    images: [
      {
        id: "img-2-1",
        url: "https://cahema.pe/73049-large_default/amoladora-angular-4-12-700w-5-discos-abrasivos-dewalt-dwe4010k-b2.jpg",
  ...
  },
  {
    ...
    categoryName: "Herramientas Eléctricas",
    description:
      "Compacto taladro percutor atornillador a batería de 12V Max CXT Makita. Con luz LED integrada para iluminar el área de trabajo, 20 posiciones de torque + percusión y mandril autoajustable sin llave. Liviano, ergonómico y diseñado para montajes continuos y carpintería fina.",
    shortDescription:
      "Tecnología CXT 12V, incluye 2 baterías de litio 1.5Ah, cargador rápido y maletín.",
    features: [
    ...
    images: [
      {
        id: "img-4-1",
        url: "https://cahema.pe/73161-large_default/taladro-atornillador-12-18v-bl-incl-2-bat-carg-makita-ddf489rtj.jpg",
  ...
  },
  {
    ...
    categoryName: "Herramientas Eléctricas",
    description:
      "Sierra circular manual de alto rendimiento con motor de 1500W. Capacidad de corte a 90° de 65mm y a 45° de 45mm. Con soplador de polvo integrado que mantiene la línea de corte siempre visible y placa base robusta para cortes limpios en todo tipo de maderas.",
    shortDescription:
      'Potente motor de 1500W, disco de 7-1/4" con 24 dientes de carburo de tungsteno.',
    features: [
    ...
    images: [
      {
        id: "img-11-1",
        url: "https://www.bosch-professional.com/binary/ocsmedia/optimized/750x422/o304054v54_lv-167949-12-GKS140_dyn_01.png",
  ...
  // 2. Herramientas Manuales (cat-2)
  {
    ...
    description:
      "Set completo de 123 piezas Stanley fabricado en acero cromo vanadio de alta resistencia con acabado cromado micro-satinado que evita la corrosión. Incluye dados milimétricos y en pulgadas con tecnología Maxi-Drive que incrementa el torque hasta un 15% evitando el redondeo de tuercas.",
    shortDescription:
      "123 piezas en maletín plástico ultra resistente de alta durabilidad profesional.",
    features: [
    ...
    specifications: [
      ...
      {
        name: "Estuche",
        value: "Polietileno de alta densidad (Blow Mold Case)",
      },
    ...
    images: [
      {
        id: "img-3-1",
        url: "https://imagedelivery.net/0tt38OLkrSmHRt7hdItWEA/01815110-27e7-4d9a-ce7b-804913688800/public",
        alt: "Juego de Herramientas Stanley 123 Piezas",
        isPrimary: true,
      },
      {
        id: "img-3-2",
        url: "https://image.made-in-china.com/202f0j00PyTVchDdENqf/Metric-122-PCS-Tooth-Chrome-Vanadium-Steel-Blow-Molding-Box-Ratchet-Wrench-Set.webp",
  ...
  },
  {
    ...
    categoryName: "Herramientas Manuales",
    description:
      "Nivel láser autonivelante con haz verde de alta visibilidad, hasta 4 veces más visible que el láser rojo tradicional. Proyecta líneas cruzadas horizontal y vertical para alineación exacta en drywall, cerámicos, estanterías e instalaciones eléctricas.",
    shortDescription:
      "Rango de 15 metros, haz láser verde brillante, soporte magnético incluido.",
    features: [
    ...
    images: [
      {
        id: "img-5-1",
        url: "https://cahema.pe/89965-large_default/nivel-laser-de-2-lineas-rojo-10-metros-truper-17079.jpg",
  ...
  },
  {
    ...
    categoryName: "Herramientas Manuales",
    description:
      "Martillo forjado en una sola pieza de acero de aleación con tecnología antivibración patentada AntiVibe que reduce la fatiga muscular y el choque en la muñeca. Boca pulida y uña curva afilada para fácil extracción de clavos.",
    shortDescription:
      "Cabeza de 20 oz forjada en una sola pieza, agarre de goma texturizada antideslizante.",
    features: [
    ...
    images: [
      {
        id: "img-12-1",
        url: "https://carpintec.com.pe/cdn/shop/files/Martillo_antivibe_Stanley_1024x1024.jpg?v=1761165732",
  ...
  // 3. Construcción y Fijaciones (cat-3)
  {
    ...
    description:
      "Sikaflex 1A Plus es un sellador elástico monocomponente a base de poliuretano, que cura con la humedad del ambiente. Diseñado especialmente para juntas de dilatación en muros, techos, losas, marcos de puertas y ventanas con excelente resistencia a la intemperie y rayos UV.",
    shortDescription:
      "Sellador elastomérico de alto desempeño para juntas de construcción y fachadas.",
    features: [
    ...
    images: [
      {
        id: "img-6-1",
        url: "https://http2.mlstatic.com/D_Q_NP_655041-MLU74161934229_012024-O.webp",
  ...
  },
  {
    ...
    categoryName: "Construcción y Fijaciones",
    description:
      "Cemento de uso general de alta resistencia para columnas, vigas, losas y cimentaciones. Cumple con la norma técnica peruana NTP 334.009 y ASTM C-150 Tipo I.",
    shortDescription:
      "Bolsa de 42.5 kg, fraguado óptimo y alta resistencia inicial y final.",
    features: [
    ...
    images: [
      {
        id: "img-13-1",
        url: "https://promart.vteximg.com.br/arquivos/ids/9975675/22662.jpg?v=639121427573830000",
  ...
  // 4. Pinturas y Acabados (cat-4)
  {
    ...
    description:
      "Pintura látex acrílica para interiores y exteriores de acabado mate aterciopelado. Formulada con resinas de alta calidad que brindan excelente lavabilidad, alto poder cubriente y resistencia contra el moho y la humedad.",
    shortDescription:
      "Galón 4 Litros, acabado mate uniforme, lavable y bajo olor.",
    features: [
    ...
    images: [
      {
        id: "img-7-1",
        url: "https://promart.vteximg.com.br/arquivos/ids/8887740-1000-1000/135887.jpg?v=638845947736270000",
  ...
  },
  {
    ...
    categoryName: "Pinturas y Acabados",
    description:
      "Pintura alquídica de alta durabilidad para metal, rejas, puertas y madera. Brinda protección contra el óxido y brillo duradero en exteriores.",
    shortDescription:
      "1 Galón, máxima adherencia y protección anticorrosiva para metal y madera.",
    features: [
    ...
    images: [
      {
        id: "img-14-1",
        url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNGlA1TWEe14mwqkrjNEa6fchkWzMyCcf_XEM4GgyUKA&s=10",
  ...
  // 5. Electricidad e Iluminación (cat-5)
  {
    ...
    description:
      "Conductor eléctrico de cobre electrolítico recocido de 99.9% de pureza con aislamiento termoplástico de PVC autoextinguible. Certificado para instalaciones residenciales y comerciales seguras según norma NTP 370.252.",
    shortDescription:
      "Rollo 100 metros calibre 14 AWG (2.5mm² aprox.), 100% Cobre certificado.",
    features: [
    ...
    images: [
      {
        id: "img-8-1",
        url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMfybO72nW3yqMWoM8PAjUkIQu2vKoJQd9EKJ_Og6TmmOcAYuj87vaAza4&s=10",
  ...
  },
  {
    ...
    categoryName: "Electricidad e Iluminación",
    description:
      "Proyector LED de alta potencia para exteriores, fachadas, almacenes y patios de obra. Protección IP65 resistente a la lluvia, polvo e impactos con carcasa de aluminio inyectado.",
    shortDescription:
      "100W, 10,000 lúmenes, protección IP65 para intemperie, ahorro energético 85%.",
    features: [
    ...
    images: [
      {
        id: "img-15-1",
        url: "https://media.falabella.com/falabellaPE/130308676_1/w=1500,h=1500,fit=cover",
  ...
  // 6. Gasfitería y Plomería (cat-6)
  {
    ...
    description:
      "Tubería rígida de PVC para conducción de agua potable a presión Clase 10 con unión roscada o simple presión. Fabricada bajo estrictas normas técnicas que aseguran resistencia a la presión hidráulica y larga vida útil libre de sarro.",
    shortDescription:
      "Tubo de 5 metros longitud, diámetro 1/2 pulgada, Clase 10 Pavco Wavin.",
    features: [
    ...
    images: [
      {
        id: "img-10-1",
        url: "https://malvinasferreteros.com/wp-content/uploads/2023/03/tubo-pvc-con-rosca-para-agua-de-2x5m-c10-pavco.jpg",
  ...
  },
  {
    ...
    categoryName: "Gasfitería y Plomería",
    description:
      "Cemento solvente de alta viscosidad formulado para soldar tuberías y conexiones de PVC de agua y desagüe con máxima presión.",
    shortDescription:
      "Lata de 8 onzas (237 ml) con hisopo aplicador en la tapa.",
    features: [
    ...
    images: [
      {
        id: "img-16-1",
        url: "https://promart.vteximg.com.br/arquivos/ids/557649-1000-1000/18422.jpg?v=637381395704170000",
  ...
  // 7. Seguridad Industrial / EPP (cat-7)
  {
    ...
    description:
      "Respirador reutilizable de media pieza facial 3M Serie 6000 fabricado en elastómero termoplástico hipoalergénico. Incluye par de cartuchos para vapores orgánicos y prefiltros contra partículas, ideal para pintura, solventes y lijado.",
    shortDescription:
      "Media máscara reutilizable talla M con arnés de 4 puntos y válvulas de exhalación.",
    features: [
    ...
    images: [
      {
        id: "img-9-1",
        url: "https://media.falabella.com/falabellaPE/146472066_01/w=1500,h=1500,fit=cover",
  ...
  },
  {
    ...
    categoryName: "Seguridad Industrial / EPP",
    description:
      "Casco dieléctrico de protección clase E y G ANSI/ISEA Z89.1. Con suspensión tipo ratchet ajustable con una sola mano y ranuras para orejeras y caretas.",
    shortDescription:
      "Casco tipo jockey blanco con ajuste ratchet, alta absorción de impacto.",
    features: [
    ...
    images: [
      {
        id: "img-17-1",
        url: "https://multimedia.3m.com/mws/media/1450226J/capacete-3m-h-700-ajuste-facil-branco.jpg?width=506",
        alt: "Casco 3M H-700",
        isPrimary: true,
      },
    ],
  ...
  // 8. Jardinería y Exteriores (cat-8)
  {
    ...
    description:
      "Tijera para poda de ramas verdes y secas con cuchilla forjada en acero alto carbono SK5 con recubrimiento antiadherente de teflón. Mangos ergonómicos de aluminio con revestimiento antideslizante.",
    shortDescription:
      "8 pulgadas, corte limpio hasta 20 mm de grosor, seguro de bloqueo con una mano.",
    features: [
    ...
    images: [
      {
        id: "img-18-1",
        url: "https://oechsle.vteximg.com.br/arquivos/ids/17330436-1000-1000/image-1d7c18885e4a417b8e72ab3208c162a5.jpg?v=638422212392870000",
  ...
  },
  {
    ...
    categoryName: "Jardinería y Exteriores",
    description:
      "Manguera flexible de 3 capas con malla de poliéster antitorsión y resistencia UV. Incluye acoples rápidos para caño y pistola pulverizadora regulable.",
    shortDescription:
      "Largo 25 metros, 3 capas antinudos, incluye acoples y pistola de riego.",
    features: [
    ...
    images: [
      {
        id: "img-19-1",
        url: "https://http2.mlstatic.com/D_NQ_NP_970592-MLU73883170977_012024-O.webp",
