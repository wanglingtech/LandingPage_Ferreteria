...
export const MOCK_REVIEWS: ProductReview[] = [
  {
    ...
    comment: 'Compré el kit con maletín y los accesorios son muy útiles. Tiene muy buen torque y perforó concreto sin ningún problema. La atención de Ferretería July fue de primera y llegó al día siguiente.',
  ...
  },
  {
    ...
    comment: 'La marca Bosch nunca falla. Muy buena ergonomía para largas jornadas y el selector de percutor responde de inmediato.',
  ...
  },
  {
    ...
    comment: 'Corta fierros de construcción y perfiles metálicos como mantequilla. Se nota la durabilidad de los rodamientos DeWalt.',
  ...
  },
  {
    ...
    comment: 'Los dados tienen muy buen acabado cromado y no se barren las cabezas de los pernos gracias al sistema Maxi-Drive.',
  ...
  },
  {
    ...
    userAvatar: 'https://images.unsplash.com/photo-1628157582853-a796fa650a6a?auto=format&fit=crop&w=120&q=80',
    rating: 5,
    title: 'El mejor sellador para juntas de dilatación',
    comment: 'Usamos Sikaflex 1A en toda la fachada de nuestro proyecto en Miraflores. Cero filtraciones con las lluvias.',
